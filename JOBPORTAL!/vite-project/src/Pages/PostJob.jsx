...
const PostJob = () => {
  ...
  const onSubmit = (data) => {
    data.skills = selectedOption.map(option => option.value); // Ensure skills are sent as an array of strings

    fetch("https://job-portal-backend-a057.onrender.com/post-job", {
      method: "POST",
      headers: {
        'Content-Type': 'application/json'
      },
